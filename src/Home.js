            ...
            <div className="introContainer">
                ...
                <div className="social-links">
                    <div id="linkedin" className="social-btn flex-center">
                        <Image className="linkIcons" src={linkedInIcon}></Image> <span>LinkedIn</span>
                    </div>

                    <div id="github" className="social-btn flex-center">
                        <Image className="linkIcons" src={githubIcon}></Image> <span>GitHub</span>
                    </div>
                    <div id="resume" className="social-btn flex-center">
                        <Image className="linkIcons" src={resumeIcon}></Image> <span>Download Resume</span>
                    </div>
                </div>
            </div>
        </div>
